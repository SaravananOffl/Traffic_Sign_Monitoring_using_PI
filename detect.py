    ...
    while True:
        ...
        if largestArea > frameArea*0.02:
            ...
            if(detectedTrafficSign!=None):
                ...
                data = {'time':str(time),
                        'sign' : detectedTrafficSign}
                data2= {str(time):detectedTrafficSign}
                resutl1 =firebase.post('/time_log', str(time), detectedTrafficSign)
                result = firebase.patch('/sign_log', data)
